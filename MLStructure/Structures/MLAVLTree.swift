...
import Foundation
public class MLAVLTreeNode<Key: Comparable, Payload> {
    public typealias Node = MLAVLTreeNode<Key, Payload>
...
public class MLAVLTree<Key: Comparable, Payload> {
    public typealias Node = MLAVLTreeNode<Key, Payload>
...
// MARK: - Searching
extension MLAVLTreeNode{
    public func minimum() -> MLAVLTreeNode? {
    ...
    public func maximum() -> MLAVLTreeNode? {
...
extension MLAVLTreeNode: CustomDebugStringConvertible {
...
extension MLAVLTree: CustomDebugStringConvertible {
    public var debugDescription: String {
        if let root = root {
...
extension MLAVLTreeNode: CustomStringConvertible {
...
extension MLAVLTree: CustomStringConvertible {
    public var description: String {
        if let root = root {
