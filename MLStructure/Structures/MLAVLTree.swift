...
public class MLAVLTree<T: Comparable> {
    ...
    func addNode(key: T) {
        ...
        if (key < self.key) {
            ...
            if (self.left != nil) {
                ...
                let leftChild : MLAVLTree = MLAVLTree()
                leftChild.key = key
                leftChild.height = 0
                self.left = leftChild
            }
        ...
        if (key > self.key) {
            ...
            if (self.right != nil) {
                ...
                let rightChild : MLAVLTree = MLAVLTree()
                rightChild.key = key
                rightChild.height = 0
    ...
    func getNodeHeight(aNode: MLAVLTree!) -> Int {
    ...
    func isValidAVLTree() -> Bool! {
        ...
        if (self.isTreeBalanced() == true) {
            ...
            let childToUse : MLAVLTree = MLAVLTree()
            childToUse.height = 0
    ...
    func traverse(formula: MLAVLTree<T> -> T) {
